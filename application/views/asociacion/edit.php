			...
			<div class="col-sm-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="titulo" name="titulo" placeholder="Nombre de la imagen">
                          ...
                          <input type="hidden" id="val_id_proyecto_gal" name="val_id_proyecto_gal" value="<?php echo $asociaciones[0]['id'] ?>">
			</div>
			...
			<div class="col-sm-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="titulo" name="titulo" placeholder="Nombre del documento">
                          ...
                          <input type="hidden" id="val_id_proyecto_adj" name="val_id_proyecto_adj" value="<?php echo $asociaciones[0]['id'] ?>">
			</div>
...
<!-- Content Wrapper. Contenido de la página -->
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content ">     
              ...
              <div class="tab-pane active" id="tab_3">
                  ...
                  <input type="hidden" id="id" value='<?php echo $asociaciones[0]['id']?>'>
               ...
               <div class="box box-danger">
                ...
                <div class="box-body">              
                    ...
                    <form id="formGeneral_Modificar" >                               
                      
                      <div class="form-group required">
                          <label>Misión</label>
                         <textarea class="form-control" id="tx_mision"><?php echo $asociaciones[0]['tx_mision']?></textarea>
                        </div>
                        
                        
                        <div class="form-group required">
                          <label>Visión</label>
                           <textarea class="form-control" id="tx_vision"><?php echo $asociaciones[0]['tx_vision']?></textarea>
                        </div>          
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                              ...
                              <input id="fe_registro" class="form-control pull-right" id="fe_registro" type="text" required value="<?php $date = new DateTime($asociaciones[0]['fe_registro']); echo $date->format('d/m/Y'); ?>">
                            </div>
                            <!-- /.input group -->
                          </div>
                          </div>
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="input-group date">
                              ...
                              <input id="fe_actualizacion" class="form-control pull-right" id="fe_actualizacion" type="text" required value="<?php $date = new DateTime($asociaciones[0]['fe_actualizacion']); echo $date->format('d/m/Y'); ?>">
                            </div>
                            <!-- /.input group -->
                          </div> 
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                              ...
                              <input id="tx_razon" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_razon']?>'>
                            </div>
                            
                            
                            <div class="form-group">
                              <label>RUC</label>
                              <input id="tx_ruc" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_ruc']?>'>
                            </div>
                          
                          <div class="form-group ">
                              <label>Nombre Comercial</label>
                               <input id="tx_nombre" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_nombre']?>'>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group date">
                              ...
                              <input id="fe_inicio_actividades" class="form-control pull-right" type="text" required value="<?php $date = new DateTime($asociaciones[0]['fe_inicio_actividades']); echo $date->format('d/m/Y'); ?>">
                            </div>
                            <!-- /.input group -->
                          </div> 
                           ...
                           <div class="form-group  ">
                              ...
                              <input id="tx_telefono" type="tel" class="form-control"  value='<?php echo $asociaciones[0]['tx_telefono']?>'>
                          </div>    
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="form-group ">
                              <label>Página web</label>
                               <input id="tx_pagina" type="text" class="form-control"  value='<?php echo $asociaciones[0]['tx_pagina']?>'>
                         </div>
                        
                        
                         <div class="form-group ">
                              <label>Correo electrónico</label>
                               <input id="tx_correo" type="email" class="form-control" value='<?php echo $asociaciones[0]['tx_correo']?>'>
                         </div>
                           

                          <div class="form-group  ">
                              <label>Número de socios colonos</label>
                              <input id="nu_socios_colonos" type="tel" class="form-control"  value='<?php echo $asociaciones[0]['nu_socios_colonos']?>'>
                          </div>  

                          <div class="form-group  ">
                              <label>Número de socios indígenas</label>
                              <input id="nu_socios_indigenas" type="tel" class="form-control"  value='<?php echo $asociaciones[0]['nu_socios_indigenas']?>'>
                          </div>  

                          <div class="form-group  ">
                              <label>Número total de socios</label>
                              <input id="nu_socios_total" type="number" class="form-control" disabled value='<?php echo $asociaciones[0]['nu_socios_total']?>'>
                          </div>
                       ...
                       <div class="form-group required">
                        <label>Región</label>
                          ...
                          <?php for ($i = 0; $i < count($regiones); $i++) { 
                              ...
                              $selected = '';
                              if($regiones[$i]['id'] == $asociaciones[0]['id_region_ejec'] ) $selected = 'selected';
                        ...
                        <label>Provincia</label>
                          ...
                          <?php for ($i = 0; $i < count($provincias); $i++) { 
                              ...
                              $selected = '';
                              if($provincias[$i]['id'] == $asociaciones[0]['id_provincia_ejec'] ) $selected = 'selected';
                       ...
                       <div class="form-group required">
                        ...
                        <select id="id_distrito_ejec" class="form-control select2" style="width: 100%;"  required >
                           <?php for ($i = 0; $i < count($distritos); $i++) { 
                              ...
                              $selected = '';
                              if($distritos[$i]['id'] == $asociaciones[0]['id_distrito_ejec'] ) $selected = 'selected';
                        ...
                        <div class="col-md-6">     
                         ...
                         <div class="form-group required">
                            <label>Centro poblado</label>
                             <select id="id_centro_poblado_ejec" class="form-control select2" style="width: 100%;">
                               <?php for ($i = 0; $i < count($centros_poblados_ejec); $i++) { 
                      
                                  $selected = '';
                                  if($centros_poblados_ejec[$i]['codcp'] == $asociaciones[0]['id_centro_poblado_ejec'] ) $selected = 'selected';
            
                                echo "<option $selected value='".$centros_poblados_ejec[$i]['codcp']."'> ".$centros_poblados_ejec[$i]['nomcp']."</option>";
                            ...
                            <div class="form-group ">
                              ...
                              <input id="tx_centro_poblado_direccion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_centro_poblado_direccion']?>'>
                            </div>

                            <div class="form-group required">
                              <label>Dirección</label>
                             <textarea class="form-control" id="tx_direccion"><?php echo $asociaciones[0]['tx_direccion']?></textarea>
                            </div>
                      ...
                      <div class="row">
                        ...
                        <label>Región</label>
                          ...
                          <?php for ($i = 0; $i < count($regiones); $i++) { 
                              ...
                              $selected = '';
                              if($regiones[$i]['id'] == $asociaciones[0]['id_region'] ) $selected = 'selected';
                      ...
                      <div class="form-group required">
                        <label>Provincia</label>
                          ...
                          <?php for ($i = 0; $i < count($provincias); $i++) { 
                              ...
                              $selected = '';
                              if($provincias[$i]['id'] == $asociaciones[0]['id_provincia'] ) $selected = 'selected';
                       ...
                       <div class="form-group required">
                        ...
                        <select id="id_distrito" class="form-control select2" style="width: 100%;"  required >
                           <?php for ($i = 0; $i < count($distritos); $i++) { 
                              ...
                              $selected = '';
                              if($distritos[$i]['id'] == $asociaciones[0]['id_distrito'] ) $selected = 'selected';
                        ...
                        <div class="form-group required">
                          ...
                          <div class="input-group input-group-sm">
                           ...
                           <button id="btnModificar_General" type="submit" class="btn btn-success pull-right  " >
                          <i class="fa fa-download"></i> Modificar </button>
                         </form>    
              ...
              <!-- /.tab-pane -->
               ...
               <div class="tab-pane" id="tab_4">                   
                   <form id="formEstructura_Modificar">
                    <div class="box box-danger">
                       <?php   $tipo_empresa = array('Asociación', 'Cooperativa'); ?> 
                     
                        <div class="form-group ">
                            <label>Certificación</label>
                            <select id="tx_tipo" class="form-control select2" style="width: 100%;" >
                             <?php for ($i = 0; $i < count($tipo_empresa); $i++) { 

                                $selected = '';
                                if($tipo_empresa[$i] == $asociaciones[0]['tx_tipo'] ) 
                                $selected = 'selected';
                                echo "<option $selected  value='".$tipo_empresa[$i]."'> ".$tipo_empresa[$i]."</option>";
              ...
              <!-- Default box -->
                      ...
                      <div class="row">
                        <div class="col-md-6">          
                         ...
                         <div class="form-group ">
                              ...
                              <input id="tx_presidente_ca" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_presidente_ca']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Vicepresidente</label>
                              <input id="tx_vicepresidente_ca" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vicepresidente_ca']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Secretario</label>
                              <input id="tx_secretario_ca" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_secretario_ca']?>'>
                          </div>

                          <div class="form-group ">
                              <label>Vocal #1</label>
                              <input id="tx_vocal_1_ca" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vocal_1_ca']?>'>
                          </div>

                          <div class="form-group ">
                              <label>Vocal #2</label>
                              <input id="tx_vocal_2_ca" type="text" class="form-control"value='<?php echo $asociaciones[0]['tx_vocal_2_ca']?>'>
                          </div>
                          <br>
                           <h4 class="box-title">Comite de Educación</h4>
                          <div class="form-group ">
                              <label>Presidente</label>
                              <input id="tx_presidente_ceduc" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_presidente_ceduc']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Vicepresidente</label>
                              <input id="tx_vicepresidente_ceduc" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vicepresidente_ceduc']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Secretario</label>
                              <input id="tx_secretario_ceduc" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_secretario_ceduc']?>'>
                          </div>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="form-group ">
                              <label>Presidente</label>
                              <input id="tx_presidente_celect" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_presidente_celect']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Vicepresidente</label>
                              <input id="tx_vicepresidente_celect" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vicepresidente_celect']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Secretario</label>
                              <input id="tx_secretario_celect" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_secretario_celect']?>'>
                          </div>
                          <br>
                         ...
                         <div class="form-group ">
                              ...
                              <input id="tx_nombre_gerente" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_nombre_gerente']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Número de celular</label>
                              <input id="tx_telefono_gerente" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_telefono_gerente']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Correo Electrónico</label>
                              <input id="tx_correo_gerente" type="email" class="form-control" value='<?php echo $asociaciones[0]['tx_correo_gerente']?>'>
                          </div>
                    ...
                    <div class="box-body">
                      <div class="row">
                        <div class="col-md-6">                                     
                            ...
                            <div class="form-group ">
                              <label>Presidente</label>
                              <input id="tx_presidente_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_presidente_asociacion']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Vicepresidente</label>
                              <input id="tx_vicepresidente_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vicepresidente_asociacion']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Secretario</label>
                              <input id="tx_secretario_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vicepresidente_asociacion']?>'>
                          </div>
                        ...
                        <div class="col-md-6">                           
                          ...
                          <div class="form-group ">
                              ...
                              <input id="tx_tesorero_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_tesorero_asociacion']?>'>
                          </div>

                          <div class="form-group ">
                              <label>Vocal #1</label>
                              <input id="tx_vocal_1_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vocal_1_asociacion']?>'>
                          </div>

                          <div class="form-group ">
                              <label>Vocal #2</label>
                              <input id="tx_vocal_2_asociacion" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_vocal_2_asociacion']?>'>
                          </div>                         
                  ...
                  <div class="box box-body">
                     <button id="btnModificar_Estructura" type="submit" class="btn btn-success pull-right  " >
                     <i class="fa fa-download"></i> Modificar</button>
                   </form>                             
                  </div>              
                ...
                <div class="box box-danger">
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">
                     ...
                     <form id="formProduccion_Modificar">
                      ...
                      <div class="row">
                        <div class="col-md-6">                                     
                            ...
                            <div class="form-group ">
                              ...
                              <input id="tx_oferta_cafe" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_oferta_cafe']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Época de cosecha</label>
                              <input id="tx_cosecha_cafe" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_cosecha_cafe']?>'>
                          </div>

                           <div class="form-group ">
                              <label>Calidad en taza</label>
                              <input id="tx_calidad_cafe" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_calidad_cafe']?>'>
                          </div>
                        ...
                        <div class="form-group ">
                              ...
                              <input id="tx_produccion_cafe" type="text" class="form-control"  value='<?php echo $asociaciones[0]['tx_produccion_cafe']?>'>
                          </div>

                          <div class="form-group ">
                              <label>Variedades</label>
                              <input id="tx_variedades_cafe" type="text" class="form-control"  value='<?php echo $asociaciones[0]['tx_variedades_cafe']?>'>
                          </div>
                          ...
                          <div class="col-md-6"> 
                           ...
                           <div class="checkbox">
                            <label>
                              <input type="checkbox" id="tx_cert1_cafe" value="Fairtrade-Comercio Justo">Fairtrade-Comercio Justo
                            </label>
                          </div>
                          <div class="checkbox">
                    ...
                    <div class="box-body">
                      <div class="row">
                        <div class="col-md-6">                                     
                            ...
                            <div class="form-group ">
                              <label>Oferta Exportable</label>
                              <input id="tx_oferta_cacao" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_oferta_cacao']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Época de cosecha</label>
                              <input id="tx_cosecha_cacao" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_cosecha_cacao']?>'>
                          </div>
                            
                            <div class="form-group ">
                              <label>Has en producción</label>
                              <input id="tx_produccion_cacao" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_produccion_cacao']?>'>
                          </div>                          
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group ">
                              <label>Variedades</label>
                              <input id="tx_variedades_cacao" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_variedades_cacao']?>'>
                          </div>
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group ">
                              ...
                              <input id="tx_otro" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_otro']?>'>
                          </div>                                   
                            
                            <div class="form-group ">
                              <label>Oferta Exportable</label>
                              <input id="tx_oferta_otro" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_oferta_otro']?>'>
                          </div>
                          
                           <div class="form-group ">
                              <label>Época de cosecha</label>
                              <input id="tx_cosecha_otro" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_cosecha_otro']?>'>
                          </div>                          
                        ...
                        <div class="form-group ">
                              <label>Has en producción</label>
                              <input id="tx_produccion_otro" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_produccion_otro']?>'>
                          </div>                           

                          <div class="form-group ">
                              <label>Variedades</label>
                              <input id="tx_variedades_otro" type="text" class="form-control" value='<?php echo $asociaciones[0]['tx_variedades_otro']?>'>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">                                     
                            ...
                            <div class="form-group required">
                              ...
                              <input id="tx_capacitacion" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_capacitacion']?>'>
                          </div>
                          
                           <div class="form-group required">
                              <label>Acopio</label>
                              <input id="tx_acopio" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_acopio']?>'>
                          </div>
                        ...
                        <div class="form-group required">
                              ...
                              <input id="tx_comercializacion" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_comercializacion']?>'>
                          </div>                            
                      ...
                      <div class="row">
                        <div class="col-md-6">                                     
                            ...
                            <div class="form-group required">
                              ...
                              <input id="tx_productos" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_productos']?>'>
                          </div>       
                        ...
                        <div class="col-md-6">                           
                          ...
                          <div class="form-group required">
                              ...
                              <input id="tx_servicios" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_servicios']?>'>
                          </div>                         
                ...
                <div class="box box-danger">
                  <div class="box-header with-border">
                   ...
                   <div class="box-body">      
                    <div class="form-group required">
                         ...
                         <textarea class="form-control" id="tx_descripcion_logros"><?php echo $asociaciones[0]['tx_descripcion_logros']?></textarea>
                    </div>
                  ...
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">                     
                            <div class="form-group required">
                              <label>Descripción</label>
                              <textarea class="form-control" id="tx_descripcion_clientes"><?php echo $asociaciones[0]['tx_descripcion_clientes']?></textarea>
                          </div>
                  ...
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">                     
                            <div class="form-group required">
                              <label>Descripción</label>
                               <textarea class="form-control" id="tx_descripcion_alianzas" ><?php echo $asociaciones[0]['tx_descripcion_alianzas']?></textarea>
                          </div>
                  ...
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">                     
                            <div class="form-group required">
                              ...
                              <input id="tx_descripcion_siguenos" type="text" class="form-control" required value='<?php echo $asociaciones[0]['tx_descripcion_siguenos']?>'>
                          </div>
      ...
      <!-- /.tab-pane -->
          ...
          <div class="box box-danger">
            <div class="box-header">
             ...
             <button type="button" id="addPdf" name="addPdf" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Nuevo</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">             
  ...
  <?php foreach ($pdfs as $pdf): ?>
      ...
      <div class="col-sm-4 col-md-4" id="img_<?php echo $pdf->id ?>" >
        <div class="thumbnail">

         
            <img height="128" width="128" src="<?php echo base_url('pdf/pdf.png'); ?>" class="img img-responsive" />
       

          <div class="caption">
            
             <p class='text-center'><a target='_blank' href="<?php echo base_url('pdf/'.$pdf->imagen) ?>">Descargar (<?=$pdf->titulo ?>) </a></p>  
           
 
<button type='button' data-pdf-id="<?php echo $pdf->id; ?>" data-toggle='modal' data-target='#modal-eliminar-pdf' class='btn btn-danger'>
...
<button type='button' data-imagen-id="<?php echo $galeria->id; ?>" data-toggle='modal' data-target='#modal-eliminar-img' class='btn btn-danger'>
<i class="fa fa-close"></i> Eliminar</button>  
...
$(function () {
   ...
   $('.select2').select2();            
    ...
    $('#fe_registro').datepicker();
    $('#fe_actualizacion').datepicker();
    $('#fe_inicio').datepicker();
    $('#fe_fin').datepicker();
    $('#fe_inicio_actividades').datepicker();    
   
    counteCP = 1;

    $("#box_cooperativa").hide();
    $("#box_asociacion").hide();           
    actualizar_vista_tipo();
    consultar_tabla_proyecto();
    dibujar_certificaciones();
    ...
    $("#id_region").change(function(){
       ...
       $( "#id_provincia").empty();
          ...
          $.ajax({
                url: base_url+'/asociacion/buscar_provincia',                               
                data: {
      ...
      $("#id_region_ejec").change(function(){
       ...
       $( "#id_provincia_ejec").empty();
          ...
          $.ajax({
                url: base_url+'/asociacion/buscar_distrito',                               
                data: {
                    id_region: $( "#id_region option:selected" ).val(),                                           
      ...
      $("#id_distrito").change(function(){
       ...
       $( "#id_centro_poblado").empty();
          ...
          $.ajax({
                url: base_url+'/asociacion/buscar_centro_poblado',                               
                data: {
      ...
      $("#id_distrito_ejec").change(function(){
       ...
       $( "#id_centro_poblado_ejec").empty();
        ...
        $('#formGeneral_Modificar').submit(function(e){
       // $('#btnGuardar').click(function(e){
          ...
          var data_centro_poblado = JSON.stringify( dataCP );  
            ...
            $.ajax({
                url: base_url+'/asociacion/modificar_general',                               
                data: {
                ...
                success: function (result) {
                    ...
                    activar_mensaje("Información", "Registro actualizado correctamente");                           
       ...
       //$('#formEstructura_Modificar').submit(function(e){
       $('#btnModificar_Estructura').click(function(e){
 ...
 $('#formProduccion_Modificar').submit(function(e){
       // $('#btnGuardar').click(function(e){
  ...
  if ($('#tx_cert10_otro:checked').val()!=undefined) {tx_certificacion_otro =tx_certificacion_otro+$('#tx_cert10_otro:checked').val()}
    ...
    var base_url = '<?php echo site_url() ?>';
        ...
        $('#formOtros_Modificar').submit(function(e){
       // $('#btnGuardar').click(function(e){
    ...
    function actualizar_vista_tipo (){
  ...
  function dibujar_certificaciones(){         
         
      var arrayJS=<?php echo json_encode($asociaciones[0]['tx_certificacion_cafe']);?>;     
      for (var i = 0; i < arrayJS.length; i++) {      
        v=i+1;        
        if ((arrayJS[i]).trim()==$("#tx_cert"+v+"_cafe").val()) {          
          $("#tx_cert"+v+"_cafe").prop('checked', true);
        }
       }
        var arrayJS=<?php echo json_encode($asociaciones[0]['tx_certificacion_cacao']);?>;     
      for (var i = 0; i < arrayJS.length; i++) {      
        v=i+1;        
        if ((arrayJS[i]).trim()==$("#tx_cert"+v+"_cacao").val()) {          
          $("#tx_cert"+v+"_cacao").prop('checked', true);
        }
       }
        var arrayJS=<?php echo json_encode($asociaciones[0]['tx_certificacion_otro']);?>;     
      for (var i = 0; i < arrayJS.length; i++) {      
        v=i+1;        
        if ((arrayJS[i]).trim()==$("#tx_cert"+v+"_otro").val()) {          
          $("#tx_cert"+v+"_otro").prop('checked', true);
        }
       }      
