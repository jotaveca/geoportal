  ...
  <div class="content-wrapper">
    ...
    <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Administración de proyectos</h3> <button id="btnNuevo"  type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Nuevo  </button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             ...
             <?php for($i=0;$i<count($proyectos);$i++){ 
              ...
              $fe_inicio = Date_create($proyectos[$i]['fe_inicio']);
              $fe_inicio_n = Date_format($fe_inicio, "d/m/Y");

              $fe_fin = Date_create($proyectos[$i]['fe_fin']);
              $fe_fin_n = Date_format($fe_fin, "d/m/Y");

              ?>
             <tr id="tr_<?php echo  $proyectos[$i]['id'] ?>">
             <td><?php echo $i+1 ?></td>
             <td><?php echo $proyectos[$i]['tx_nombre'] ?></td>
             <td><?php echo $proyectos[$i]['tx_razon_social'] ?></td>
             <td><?php echo $proyectos[$i]['tx_rubro'] ?></td>
             <td><?php echo $fe_inicio_n ?></td>             
             <td><?php echo $fe_fin_n ?></td>               
...
<script>
  $(function () {
    ...
    $('#tbl_usuarios').DataTable({
         columnDefs: [
            { width: '5%', targets: 0, width: '15%', targets: 6 }
        ],
        fixedColumns: true,
        "language": {
  ...
  */
    ...
    $('#btnEliminarProyecto').click(function(){
        ...
        var id_proyecto= $( "#id_proyecto_eliminar").val();
          ...
          $.ajax({
                url: base_url+'/proyecto/eliminar',                   
                data: {
 ...
 * EDITAR USUARIO
  */
    ...
    $('#btnEditarProyecto').click(function(){
        ...
        //location.href= base_url+'/proyecto/edit?id_proyecto=id_proyecto";  
        location.href= "<?php echo base_url(); ?>index.php/proyecto/edit?id_proyecto="+id_proyecto;
    ...
    $('#btnExportarProyecto').click(function(){
        ...
        //location.href= base_url+'/proyecto/edit?id_proyecto=id_proyecto";  
        location.href= "<?php echo base_url(); ?>index.php/proyecto/exportar_excel?id_proyecto="+id_proyecto;
    ...
    $('#btnNuevo').click(function(){
            ...
            location.href= "<?php echo base_url(); ?>index.php/proyecto/new";
